...
train_dataset = CIFAR100(root=path, train=True, download=True, transform=transform)
test_dataset = CIFAR100(root=path, train=False, download=True, transform=transform)
...
# 모델의 입력 특성 개수 정의: CIFAR-100은 32x32 컬러(3채널) 이미지이므로 32*32*3 = 3072 입니다.
...
class DNN(nn.Module):
    def __init__(self, num_features):
        ...
        self.layers = nn.Sequential(
            ...
            nn.Linear(64, 32),
            nn.ReLU(),
            nn.Linear(32, 100) # CIFAR-100은 100개의 클래스
        )
...
# Final Test Loss: 3.7978, Final Test Acc: 0.1200