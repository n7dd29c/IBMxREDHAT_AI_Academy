...
print('ACC origin : ', model.score(x_test, y_test))    # ACC origin :  0.9649122807017544
...
print('ACC drop : ', model.score(x1_test, y_test))    # ACC drop :  0.9649122807017544
...
model.fit(x_train, y_train)
print('ACC PCA : ', model.score(x_test, y_test))    # ACC PCA :  0.9649122807017544