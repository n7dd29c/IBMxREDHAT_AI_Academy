...
# - best_score :  0.9379852788631929
# - mode.score :  0.9434696178239804
# - accuracy_score :  0.9434696178239804
# - 걸린시간 :  1981.91 초
...
pd.DataFrame(model.cv_results_).sort_values\
    ('rank_test_score', ascending=True).to_csv(path + 'm15_GS_fetch_covtype_results.csv')