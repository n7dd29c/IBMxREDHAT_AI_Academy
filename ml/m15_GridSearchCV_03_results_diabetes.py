...
# - best_score :  0.3506263013337774
# - mode.score :  0.4169694650833011
# - R2_score :  0.4169694650833011
# - 걸린시간 :  4.91 초
...
pd.DataFrame(model.cv_results_).sort_values\
    ('rank_test_score', ascending=True).to_csv(path + 'm15_GS_diabetes_results.csv')