...
pd.DataFrame(model.cv_results_).sort_values\
    ('rank_test_score', ascending=True).to_csv(path + 'm22_HRS_dacon_diabetes_results.csv')
    
import joblib
joblib.dump(model.best_estimator_, path + 'm22_HRS_dacon_diabetes_best.joblib')