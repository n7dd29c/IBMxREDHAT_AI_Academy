...
print('R2 origin : ', model.score(x_test, y_test))    # R2 origin :  0.3032136559486389
...
print('R2 drop : ', model.score(x1_test, y_test))    # R2 drop :  0.30135852098464966
...
model.fit(x_train, y_train)
print('R2 PCA : ', model.score(x_test, y_test))    # R2 PCA :  0.3075188398361206