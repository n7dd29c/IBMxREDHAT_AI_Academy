...
# - best_score :  0.3327476577719805
# - mode.score :  0.3908664408632073
# - R2_score :  0.3908664408632073
# - 걸린시간 :  4.05 초
...
pd.DataFrame(model.cv_results_).sort_values\
    ('rank_test_score', ascending=True).to_csv(path + 'm22_HRS_diabetes_results.csv')
    
joblib.dump(model.best_estimator_, path + 'm22_HRS_diabetes_best.joblib')