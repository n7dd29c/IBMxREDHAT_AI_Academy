...
# - 최적의 파라미터 :  {'n_estimators': 500, 'max_depth': 12, 'learning_rate': 0.1}
# - best_score :  0.9050750000000001
# - mode.score :  0.904725
# - accuracy_score :  0.904725
# - 걸린시간 :  335.88 초
...
path = './Study25/_save/RSCV/'
joblib.dump(model.best_estimator_, path + 'm18_RSCV_12_best_model.joblib')