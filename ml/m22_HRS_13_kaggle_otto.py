...
# - best_score :  0.8103119987926434
# - mode.score :  0.8301551389786684
# - accuracy_score :  0.8301551389786684
# - 걸린시간 :  91.03 초
...
pd.DataFrame(model.cv_results_).sort_values\
    ('rank_test_score', ascending=True).to_csv(path + 'm22_HRS_otto_results.csv')
    
import joblib
joblib.dump(model.best_estimator_, path + 'm22_HRS_otto_best.joblib')