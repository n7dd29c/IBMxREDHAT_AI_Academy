...
# - best_score :  0.3466474890708923
# - mode.score :  0.3744114637374878
# - r2_score :  0.3744114637374878
# - 걸린시간 :  9.82 초
...
pd.DataFrame(model.cv_results_).sort_values\
    ('rank_test_score', ascending=True).to_csv(path + 'm15_GS_bike_results.csv')