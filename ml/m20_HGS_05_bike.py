...
# - best_score :  0.09279181957244872
# - mode.score :  0.2303708791732788
# - r2_score :  0.2303708791732788
# - 걸린시간 :  5.63 초
...
pd.DataFrame(model.cv_results_).sort_values\
    ('rank_test_score', ascending=True).to_csv(path + 'm20_HGS_bike_results.csv')
    
joblib.dump(model.best_estimator_, path + 'm20_HGS_california_best.joblib')