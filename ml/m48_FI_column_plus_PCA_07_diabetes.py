...
print('R2 origin : ', model.score(x_test, y_test))    # R2 origin :  0.7709923664122137
...
print('R2 drop : ', model.score(x1_test, y_test))    # R2 drop :  0.7251908396946565
...
model.fit(x_train, y_train)
print('R2 PCA : ', model.score(x_test, y_test))    # R2 PCA :  0.732824427480916