...
print('ACC origin : ', model.score(x_test, y_test))    #ACC origin :  1.0
...
print('ACC drop : ', model.score(x1_test, y_test))    # ACC drop :  1.0
...
model.fit(x_train, y_train)
print('ACC PCA : ', model.score(x_test, y_test))    # R2 PCA :  0.5