...
# - 최적의 파라미터 :  {'learning_rate': 0.01, 'max_depth': 6, 'n_estimators': 500}
# - best_score :  0.7734798534798534
# - mode.score :  0.7862595419847328
...
pd.DataFrame(model.cv_results_).sort_values\
    ('rank_test_score', ascending=True).to_csv(path + 'm15_GS_dacon_diabetes_results.csv')