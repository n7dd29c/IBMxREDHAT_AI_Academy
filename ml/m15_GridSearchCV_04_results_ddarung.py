...
# - 최적의 파라미터 :  {'learning_rate': 0.1, 'min_child_weight': 3}
# - best_score :  0.7879956452447242
# - mode.score :  0.7584848552634066
# - R2_score :  0.7584848552634066
# - 걸린시간 :  9.84 초
...
pd.DataFrame(model.cv_results_).sort_values\
    ('rank_test_score', ascending=True).to_csv(path + 'm15_GS_ddarung_results.csv')