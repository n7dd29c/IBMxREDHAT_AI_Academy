...
print('R2 origin : ', model.score(x_test, y_test))    # R2 origin :  0.38520249164165343
...
print('R2 drop : ', model.score(x1_test, y_test))    # R2 drop :  0.31954334686275887
...
model.fit(x_train, y_train)
print('R2 PCA : ', model.score(x_test, y_test))    # R2 PCA :  0.3739730578600804