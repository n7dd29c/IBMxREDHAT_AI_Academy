...
print(xy_train[0][0].shape) # (100, 100, 100, 1)
...
np.save(np_path + 'keras46_01_x_train_brain.npy', arr=x_tr)
np.save(np_path + 'keras46_01_y_train_brain.npy', arr=y_tr)
np.save(np_path + 'keras46_01_x_sub_brain.npy', arr=x_sub)