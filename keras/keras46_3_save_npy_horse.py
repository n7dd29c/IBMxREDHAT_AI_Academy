...
train_path = './_data/kaggle/horse_or_humen/'
test_path = './_data/kaggle/horse_or_humen/'
...
print('x.shape', x_tr.shape)   # x.shape (1027, 100, 100, 3)
print('y.shape', y_tr.shape)   # y.shape (1027,)

np_path = 'c:/study25/_data/_save_npy/'
np.save(np_path + 'keras46_01_x_train_horse.npy', arr=x_tr)
np.save(np_path + 'keras46_01_y_train_horse.npy', arr=y_tr)
np.save(np_path + 'keras46_01_x_sub_horse.npy', arr=x_sub)